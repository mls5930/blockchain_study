...
import {Headerhandle} from "../hooks/headerLi"
...
export const Header = () => {
    return (
        <HeaderWrapper>
            <ul>
                <Headerhandle ruter="/"/>
                <Headerhandle ruter="/about"/>
                <Headerhandle ruter="/contact"/>
                <Headerhandle ruter="/login"/>
                <Headerhandle ruter="/customhooktest"/>
                <Headerhandle ruter="/customhooktest2"/>
            </ul>
        </HeaderWrapper>
    )
}