...
describe("/sign 시나리오 사용자 요청 처리", () => {
    ...
    it("서명된 메시지를 읽어와서 mint를 실행한다.", async() => {
        ...
        */
        ...
        const privateKey = "0xb49c9320156216c5d795b72f5374e43caaedfc15b7cf8e608527fbc9ad0d31c6";
        ...
        // 컨트랙트 인스턴 연결
        const contractAddress = contractJSON.networks["1747627969379"].address;
        const tokenAddress = tokenJSON.networks["1747627969379"].address;
