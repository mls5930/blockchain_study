...
const getContractInstance = async () => {
    ...
    const contract = await new web3.eth.Contract(abi, "0xa96753203b7d53e2a41206aa92447e8bb56b9a8d");
    return contract;
}
...
const gameStart = async () => {
    try {
        ...
        await contract.methods.setTicket().send({
            from: account,
...
const getContract = async () => {
    ...
    const contract = new web3.eth.Contract(abi, "0xa96753203b7d53e2a41206aa92447e8bb56b9a8d");
    return contract;
}
